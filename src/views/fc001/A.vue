<template>
    ...
    <br>
    <div>{{fc001Store.count}}<span style="padding-left: 10px;"><button @click="addCount">Add</button></span>
        <span style="padding-left: 5px;"><button @click="minusCount">Minus</button></span></div>
